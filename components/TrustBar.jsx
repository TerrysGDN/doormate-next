const TRUST_ITEMS = [
  {
    ...
    heading: 'UK Manufactured',
    body: 'Barn door hardware made in Cardiff',
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    heading: 'As Seen On Channel 4',
    body: "George Clarke's Old House New Home",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    body: '029 2166 0393 — Mon–Sat 9–5',
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    heading: 'Trading Since 2009',
    body: 'Over 15 years — thousands of systems installed',
  },
]
...
export default function TrustBar() {
  return (
    <section className="bg-white border-b border-gray-100">
      <div className="max-w-site mx-auto px-5 xl:px-16 py-6 grid grid-cols-2 lg:grid-cols-4 gap-6">
        {TRUST_ITEMS.map((item) => (
          <div key={item.heading} className="flex items-start gap-3">
            <div className="text-brand-gold flex-shrink-0 mt-0.5">{item.icon}</div>
            <div>
              <p className="text-brand-navy font-bold text-xs leading-tight">{item.heading}</p>
              <p className="text-gray-500 text-xs mt-0.5 leading-snug">{item.body}</p>
            </div>
          </div>
        ))}
      </div>
